...
Run: python -m acoustic_freeform.dual.precision CONFIG --out NEW_DIRECTORY
...
from .optics import fixed_detector_spot_jacobian
...
def run(inputs_path, output, cache_from=None):
    ...
    initial_file = Path(inputs["initial_drive_file"])
