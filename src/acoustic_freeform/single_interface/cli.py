...
def main():
    if len(sys.argv) > 1 and sys.argv[1] == "planar":
        from ..planar.cli import main as planar_main
    ...
    from .config import LensConfig, load_config
    ...
    if args.command == "evolve":
        ...
        from .coupled_refinement import coupled_study
        ...
        from .frequency_screen import frequency_study
        ...
        from .stationary import regrid_stationary
        ...
        if (args.result / "stationary.npz").exists():
            from .stationary_visualization import render_stationary

            print(render_stationary(args.result))
            return
        from .visualization import export_viewer, render_figures
        ...
        if (args.result / "stationary.npz").exists():
            ...
            print(viewer)
            return
        from .visualization import serve_viewer
        ...
        if (args.result / "stationary.npz").exists():
            from .stationary import verify_stationary

            verify_stationary(args.result)
            return
        from .validation import flat_cavity_check, spatial_convergence
        ...
        if (args.result / "stationary.npz").exists():
            ...
            return
        from .excitation import export_excitation
