...
from ..inverse.coherent import synthesize, synthesize_with_annulus
from ..mechanics.surface import CartesianPatch, DualSurface
from ..verify.analytic import verify_capillary, verify_slab
from ..verify.metrics import geometric_acceptance, maximum_error
from .equilibrium import coupled_equilibrium
...
def run(configuration: Path, output: Path):
    ...
    for case in inputs["cases"]:
        ...
        if initial_file is not None:
            initial_file = data_path(initial_file)
