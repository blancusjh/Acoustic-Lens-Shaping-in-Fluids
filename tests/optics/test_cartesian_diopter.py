...
from acoustic_freeform.single_interface.stationary import linear_stability
from acoustic_freeform.single_interface.surface import SurfaceSpace
from acoustic_freeform.single_interface.validation import fixed_drive_equilibrium
...
def test_stationary_algebraic_success_cannot_override_physical_balance(monkeypatch):
    ...
    from acoustic_freeform.single_interface import validation
