...
from acoustic_freeform.optics.raytrace import (
    fixed_detector_spot_jacobian,
    trace_graph_pair,
    trace_pair,
)
from acoustic_freeform.optics.stigmatic import pair_prescription, stigmatic_pair
