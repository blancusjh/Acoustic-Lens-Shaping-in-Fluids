...
| [Chesneau et al., PRE 106, 065104 (2022)](https://doi.org/10.1103/PhysRevE.106.065104), *Numerical simulation of universal morphogenesis of fluid interface deformations driven by radiation pressure* | Radiation tensor, coupled wave/two-phase creeping-flow formulation, BEM and propagation feedback | Present implementation uses its flat-interface stress limit; it does not reproduce their nonlinear coupled solver |
...
| [Denner, PRE 94, 023110 (2016)](https://doi.org/10.1103/PhysRevE.94.023110), *Frequency dispersion of small-amplitude capillary waves in viscous fluids* | Check assumptions about viscous damping and where simple wave descriptions fail | Its fuller viscous analysis is not implemented in the present weak-damping closure |
...
- A transient surface, a relaxed liquid equilibrium, and a cured solid optical
  figure are different outcomes. The present examples are transient surfaces.
...
Our apparatus dimensions and the idealized viscous pair are research inputs,
not material constants extracted from these papers. Resin-specific data remain open.
